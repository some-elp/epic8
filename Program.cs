...
namespace epic8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Character MLAria = new Character("Disciplinary Prefect Aria", Element.Dark, "Warrior", MLAriaStats, MLAriaStats, [], ControlType.NPC);
            Character MLArunka = new Character("Boss Arunka", Element.Light, "Knight", MLArunkaStats, MLArunkaStats, [], ControlType.NPC);
